...
- Typically 1-2 diagrams per case",
    ...
    {
        _logger.LogInformation("EXPAND: Delegating to ExpandService (EPIC-enhanced)");
        return await _expandService.ExpandCaseAsync(planJson, caseId, cancellationToken);
    }
...
";
    ...
    {
        _logger.LogInformation("DESIGN: Delegating to DesignService (EPIC 2.1, 2.2, 2.3 enhanced)");
        return await _designService.DesignCaseAsync(planJson, expandedJson, caseId, difficulty, cancellationToken);
    }
    ...
    {
        _logger.LogInformation("DOCUMENT-GEN: Delegating to DocumentGenerationService (EPIC-enhanced)");
        return await _documentService.GenerateDocumentFromSpecAsync(spec, designJson, caseId, planJson, expandJson, difficultyOverride, cancellationToken);
    }
    ...
    public async Task<string> GenerateMediaFromSpecAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        _logger.LogInformation("MEDIA-GEN: Delegating to MediaGenerationService (EPIC 2.2, 2.3 enhanced)");
        return await _mediaService.GenerateMediaFromSpecAsync(spec, designJson, caseId, planJson, expandJson, difficultyOverride, cancellationToken);
    }
