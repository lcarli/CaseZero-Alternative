...
export const ptBR: Translations = {
  ...
  submitCaseFeedbackIncorrectRetry: 'Não é bem isso. Você tem {n} tentativa(s) restante(s).',
  submitCaseFeedbackIncorrectFinal: 'Caso não resolvido. Sem mais tentativas.',
