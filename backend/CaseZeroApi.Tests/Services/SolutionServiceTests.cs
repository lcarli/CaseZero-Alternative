...
public class SolutionServiceTests : IDisposable
{
    ...
    // ──────────────────────────────────────────────────────────────
    // MaxAttempts exceeded → throws MaxAttemptsExceededException
    // ──────────────────────────────────────────────────────────────

    [Fact]
    public async Task ThreeAttempts_FourthThrowsMaxAttemptsExceededException()
    {
        ...
        await Assert.ThrowsAsync<MaxAttemptsExceededException>(() =>
            _sut.SubmitAsync(CaseId, UserId, FullyCorrectRequest()));
    }
    ...
    [Fact]
    public async Task Explanation_ReturnedWhenAttemptsExhausted()
    {
