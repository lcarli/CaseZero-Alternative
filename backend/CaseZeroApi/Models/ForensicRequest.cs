namespace CaseZeroApi.Models
{
    public class ForensicRequest
    {
        ...
        public string InputAssetId { get; set; } = string.Empty; // Renamed from EvidenceId
        public string InputAssetName { get; set; } = string.Empty; // Renamed from EvidenceName
        ...
        public string? ResultEmailId { get; set; } // Reference to the email generated with results
